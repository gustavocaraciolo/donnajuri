...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.br.donna.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.br.donna.domain.Authority.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(com.br.donna.domain.LegalProcess.class.getName() + ".user", jcacheConfiguration);
