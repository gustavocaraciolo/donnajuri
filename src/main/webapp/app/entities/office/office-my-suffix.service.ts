...
export class OfficeMySuffixService {
    ...
    create(office: OfficeMySuffix): Observable<OfficeMySuffix> {
    ...
    update(office: OfficeMySuffix): Observable<OfficeMySuffix> {
        const copy = this.convert(office);
    ...
    find(id: number): Observable<OfficeMySuffix> {
     ...
     */
    private convertItemFromServer(json: any): OfficeMySuffix {
        const entity: OfficeMySuffix = Object.assign(new OfficeMySuffix(), json);
        return entity;
    }
